...
@Processor('ThirtyMinutesCandle_Preprocessings')
@Injectable()
export class ThirtyMinutesCandle_PreprocessingsProcessor {
    private readonly logger = new Logger(ThirtyMinutesCandle_PreprocessingsProcessor.name);
