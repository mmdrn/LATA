...
@Processor('FiveMinutesCandle_Preprocessings')
@Injectable()
export class FiveMinutesCandle_PreprocessingsProcessor {
    private readonly logger = new Logger(FiveMinutesCandle_PreprocessingsProcessor.name);
