...
@Processor('OneMonthCandle_Preprocessings')
@Injectable()
export class OneMonthCandle_PreprocessingsProcessor {
    private readonly logger = new Logger(OneMonthCandle_PreprocessingsProcessor.name);
