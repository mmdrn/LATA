...
@Processor('EightHoursCandle_Preprocessings')
@Injectable()
export class EightHoursCandle_PreprocessingsProcessor {
    private readonly logger = new Logger(EightHoursCandle_PreprocessingsProcessor.name);
