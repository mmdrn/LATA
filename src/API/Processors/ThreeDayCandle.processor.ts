...
@Processor('ThreeDaysCandle_Preprocessings')
@Injectable()
export class ThreeDaysCandle_PreprocessingsProcessor {
    private readonly logger = new Logger(ThreeDaysCandle_PreprocessingsProcessor.name);
