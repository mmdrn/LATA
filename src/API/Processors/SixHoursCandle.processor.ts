...
@Processor('SixHoursCandle_Preprocessings')
@Injectable()
export class SixHoursCandle_PreprocessingsProcessor {
    private readonly logger = new Logger(SixHoursCandle_PreprocessingsProcessor.name);
