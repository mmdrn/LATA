...
@Processor('OneMinuteCandle_Preprocessings')
@Injectable()
export class OneMinuteCandle_PreprocessingsProcessor {
    private readonly logger = new Logger(OneMinuteCandle_PreprocessingsProcessor.name);
